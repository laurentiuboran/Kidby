...
public class PuzzleGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Alege un puzzle!");

        AlertDialog alertDialog = new AlertDialog.Builder(PuzzleGameActivity.this).create();
        alertDialog.setTitle("Bun venit la Puzzle!");
        alertDialog.setMessage("Pentru a începe jocul, alege un puzzle și rezolvă-l într-un timp cât mai scurt!\n\nSucces!");
        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Super!",
